  ...
  namespace GPU
  {
    namespace Program
    {
      ...
      public:
        ...
        static std::unordered_map<GPU::Program::UberParamMask, std::string>
            maskToDefines;
      ...
      public:
        ...
        virtual void
        getUberShaderDefines(std::vector<std::string> & buffer);
        virtual void
        ...
        virtual void
        onFrameBegin(EngineInstance * instance);

        virtual void
        configureMeshParameters(GPU::Mesh::GPUMesh & gpuMesh);
        virtual void
        sendMaterialParameters(const Material::Material & material);
        virtual void
        sendTransformParameters(const SceneObject & object,
                                const Camera & camera);

        virtual void
        onRenderObject(DefaultImpl::MeshRenderer & renderable,
                       const Camera & camera);
      };
    } // namespace Program
  } // namespace GPU

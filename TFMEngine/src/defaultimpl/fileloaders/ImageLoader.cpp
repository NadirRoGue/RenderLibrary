...
namespace RenderLib
{
  namespace DefaultImpl
  {
    ...
    ImageLoader::loadFile(const std::string & file, unsigned int options)
    {
      ...
      std::unique_ptr<CPU::Texture::TextureLoadResult> result
          = std::make_unique<CPU::Texture::TextureLoadResult>();

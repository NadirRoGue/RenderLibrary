...
namespace RenderLib
{
  ...
  {
    BufferedFileLogger::BufferedFileLogger() : FileLogger()
    {
    ...
    std::string
    BufferedFileLogger::buildLogString(std::vector<std::string> & buffer)
    {
      std::string result = "";
    ...
    void
    BufferedFileLogger::logInfo(const std::string & info)
    {
    ...
    void
    BufferedFileLogger::logWarning(const std::string & warn)
    {
    ...
    void
    BufferedFileLogger::logError(const std::string & error)
    {

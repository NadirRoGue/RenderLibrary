...
namespace RenderLib
{
	...
	{
		GPU::Program::UberParamMask StandardProgram::HAS_UV_ATTRIB				= 1;
		GPU::Program::UberParamMask StandardProgram::HAS_TANGENT_ATTRIB			= 2;
		GPU::Program::UberParamMask StandardProgram::HAS_COLOR_ATTRIB			= 4;

		GPU::Program::UberParamMask StandardProgram::HAS_NORMAL_ATTRIB			= 8;
		GPU::Program::UberParamMask StandardProgram::HAS_NORMAL_MAP				= 16;

		GPU::Program::UberParamMask StandardProgram::HAS_DIFFUSE_COLOR			= 32;
		GPU::Program::UberParamMask StandardProgram::HAS_DIFFUSE_TEXTURE		= 64;

		GPU::Program::UberParamMask StandardProgram::HAS_SPECULAR_COLOR			= 128;
		GPU::Program::UberParamMask StandardProgram::HAS_SPECULAR_TEXTURE		= 256;

		GPU::Program::UberParamMask StandardProgram::HAS_AMBIENT_COLOR			= 512;
		GPU::Program::UberParamMask StandardProgram::HAS_AMBIENT_TEXTURE		= 1024;

		GPU::Program::UberParamMask StandardProgram::HAS_SHININESS_VALUE		= 2048;
		GPU::Program::UberParamMask StandardProgram::HAS_SHININESS_TEXTURE		= 4096;

		GPU::Program::UberParamMask StandardProgram::HAS_EMISSIVE_COLOR			= 4096 * 2;
		GPU::Program::UberParamMask StandardProgram::HAS_EMISSIVE_TEXTURE		= 4096 * 4;

		GPU::Program::UberParamMask StandardProgram::HAS_OPACITY				= 4096 * 8;
		GPU::Program::UberParamMask StandardProgram::HAS_OPACITY_TEXTURE		= 4096 * 16;

		GPU::Program::UberParamMask StandardProgram::HAS_SPECULAR_SCALE			= 4096 * 32;
		...
		GPU::Program::UberParamMask StandardUberFactory::parseMaterial(GPU::Program::UberParamMask meshMask, Material::Material * mat)
		{
			if (mat == NULL)
			{
				return 0;
			...
			materialMask |= mat->ambientColor.paramExists() ? StandardProgram::HAS_AMBIENT_COLOR : 0;
			materialMask |= mat->diffuseColor.paramExists() ? StandardProgram::HAS_DIFFUSE_COLOR : 0;
			materialMask |= mat->specularColor.paramExists() ? StandardProgram::HAS_SPECULAR_COLOR : 0;
			materialMask |= mat->shininess.paramExists() ? StandardProgram::HAS_SHININESS_VALUE : 0;
			materialMask |= mat->opacity.paramExists() && mat->opacity() < 1.0f ? StandardProgram::HAS_OPACITY : 0;
			materialMask |= mat->emissiveColor.paramExists() ? StandardProgram::HAS_EMISSIVE_COLOR : 0;
			materialMask |= mat->specularScale.paramExists() ? StandardProgram::HAS_SPECULAR_SCALE : 0;
			...
			if (materialMask & StandardProgram::HAS_UV_ATTRIB)
			{
				...
				if (mat->normalMapTexture.textureExists() && (materialMask & StandardProgram::HAS_TANGENT_ATTRIB))
				{

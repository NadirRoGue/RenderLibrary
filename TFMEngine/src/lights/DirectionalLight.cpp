...
namespace RenderLib
{
  namespace Lighting
  {
    DirectionalLight::DirectionalLight() : Light<DirectionalLightData>()
    {
    }
    ...
    void
    DirectionalLight::setDirection(const VECTOR3 & d)
    {
    ...
    void
    DirectionalLight::update(const Camera & camera)
    {
      VECTOR4 transformed
          = camera.viewMatrix * transform.worldModelMatrix * direction;

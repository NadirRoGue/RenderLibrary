...
namespace RenderLib
{
  namespace Lighting
  {
    ...
    void
    SpotLight::setPosition(const VECTOR3 & pos)
    {
      this->position = VECTOR4(pos.x(), pos.y(), pos.z(), 1.0);
    }

    void
    SpotLight::setApperture(const float & apperture)
    {
    ...
    void
    SpotLight::setDirection(const VECTOR3 & d)
    {
    ...
    void
    SpotLight::setTheta(const float & theta)
    {
      SpotLightData & data      = getData();
    ...
    void
    SpotLight::setAttenuation(const float & linear, const float & cuadratic,
                              const float & cubic)
    {
      SpotLightData & data = getData();
    ...
    void
    SpotLight::update(const Camera & cam)
    {

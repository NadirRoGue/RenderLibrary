...
namespace RenderLib
{
  namespace Pipeline
  {
    ...
    void
    PipelineBroker::registerPipelineStage(PipelineStage * stage)
    {
      AbstractElementBasedStage * aebs
          = dynamic_cast<AbstractElementBasedStage *>(stage);
    ...
    void
    PipelineBroker::registerElement(Component * component)
    {
    ...
    PipelineBroker::getElementStages()
    {

...
namespace RenderLib
{
  namespace Render
  {
    ...
    void
    FBOManager::setEngineInstance(EngineInstance * instance)
    {
      this->instance = instance;
    }

    FBO *
    FBOManager::createFBO(const std::string & name)
    {
    ...
    FBO *
    FBOManager::getFBO(const std::string & name)
    {
      auto it = fbos.find(name);
      if (it != fbos.end())
      {
    ...
    void
    FBOManager::destroyFBO(const std::string & name)
    {
      auto it = fbos.find(name);
      if (it != fbos.end())
      {
    ...
    void
    FBOManager::onResize(const unsigned int & width,
